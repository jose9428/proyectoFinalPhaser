...
export class Game4 extends Phaser.Scene{
    ...
    preload(){
        this.load.image('fondo_nivel_4', 'images/fondo_nivel_4.jpg');
        ...
        this.load.audio('sonido_principal_4','sonidos/principal_4.mp3');
    }
    ...
    agregarVelocidadBomba3(){
        let velocity = 90 * Phaser.Math.Between(1.3 , 2);
        if(Phaser.Math.Between(0,10) > 5){
            velocity = 0 - velocity;
        }
        this.bomba3.setVelocity(velocity , 10); 
    }

    create(){ 
        this.physics.world.setBoundsCollision(true,true,true,true);
        this.add.image(400 , 250, 'fondo_nivel_4');

        this.add.text(350,2,'NIVEL 4',{
            fontSize:'20px',
            fill:'#fff',
        ...
        this.musicGame = this.sound.add('sonido_principal_4');
        ...
        this.bomba3 = this.physics.add.image(0,250,'bomba');
        this.bomba3.setCollideWorldBounds(true);
        this.bomba3.setBounce(1);
        this.agregarVelocidadBomba3();
        ...
        this.physics.add.collider(this.bomba1, this.bomba3, null, null, this);
        this.physics.add.collider(this.bomba2, this.bomba3, null, null, this);
    }
